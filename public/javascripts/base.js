//世界公屏聊天消息。
	...
	$(document).on('mouseenter mouseleave','.world_hall .room_list ul li .online ul li,.world_chat .chat_area .chat ul li .sender img,.player_list .players ul li',function(event){
